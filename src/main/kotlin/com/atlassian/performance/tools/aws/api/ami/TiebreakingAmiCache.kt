...
import com.atlassian.performance.tools.aws.api.ami.tiebreaker.NewestAvailableAmiTiebreaker
...
class TiebreakingAmiCache private constructor(
    ...
    override fun lookup(tags: Map<String, String>, aws: Aws): String? {
    ...
    class Builder {
        private var tiebreaker: AmiTiebreaker = NewestAvailableAmiTiebreaker()
